  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900">
      ...
      <motion.header
        ...
        className="fixed top-0 left-0 right-0 z-10 flex justify-between items-center px-4 sm:px-6 py-4 bg-gray-800 border-b border-gray-700 shadow-sm"
      >
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#FF0000] rounded-md flex items-center justify-center">
            <span className="text-white font-bold text-base sm:text-lg">M</span>
          </div>
          <h1 className="text-lg sm:text-xl font-bold text-white">Mustafa Canvas</h1>
        </div>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-6 lg:space-x-8">
          <Link href="#hero" className="text-gray-300 hover:text-[#FF0000] transition-colors text-sm font-medium">
            Home
          </Link>
          <Link href="#about" className="text-gray-300 hover:text-[#FF0000] transition-colors text-sm font-medium">
            About
          </Link>
          <Link href="#gallery" className="text-gray-300 hover:text-[#FF0000] transition-colors text-sm font-medium">
            Gallery
          </Link>
          <Link href="#contact" className="text-gray-300 hover:text-[#FF0000] transition-colors text-sm font-medium">
            Contact
          </Link>
        </nav>
      ...
      {mobileMenuOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className="fixed top-[60px] sm:top-[68px] left-0 right-0 z-10 bg-gray-800 shadow-sm md:hidden border-b border-gray-700"
        >
          <div className="flex flex-col py-2">
            <Link
              href="#hero"
              className="px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-[#FF0000]"
      ...
      <motion.section
        ...
        className="pt-20 sm:pt-24 md:pt-32 flex flex-col items-center justify-center min-h-[80vh] bg-gray-900 px-4 sm:px-6 md:px-8"
      >
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        variants={sectionVariants}
        className="py-16 sm:py-20 bg-gray-800 px-4 sm:px-6 md:px-8"
      >
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-white">About Us</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-10 items-center">
            ...
            <div className="rounded-md overflow-hidden shadow-md mt-4 md:mt-0 border border-gray-700">
              <Image
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        variants={sectionVariants}
        className="py-16 sm:py-20 bg-gray-900 px-4 sm:px-6 md:px-8"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">Our Gallery</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              <motion.div
                key={idx}
                whileHover={{ y: -5 }}
                className="border border-gray-700 rounded-md overflow-hidden bg-gray-800 transition-all duration-300 shadow-sm hover:shadow-md h-full"
              >
                ...
                <div className="p-4 sm:p-6">
                  <h4 className="text-base sm:text-lg font-medium text-white">{style.name} Canvas</h4>
                  <p className="text-sm text-gray-400 mt-1 sm:mt-2">{style.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-white">Contact Us</h3>
            <div className="w-12 sm:w-16 h-0.5 bg-[#FF0000] mx-auto"></div>
          </div>
            ...
            <div className="bg-gray-700 p-6 sm:p-8 rounded-md shadow-sm border border-gray-600">
              ...
              <div className="space-y-4 max-w-md mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-center justify-center sm:justify-start">
                  <span className="font-medium mb-1 sm:mb-0 sm:mr-2 text-gray-200 text-center sm:text-left">
                    Email:
                  </span>
                  <a
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-center sm:justify-start">
                  ...
                  <a href="tel:+1234567890" className="hover:text-[#FF0000] text-center sm:text-left text-gray-300">
                    (123) 456-7890
                  </a>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-center sm:justify-start">
                  ...
                  <span className="text-center sm:text-left text-gray-300">Art District, Creative City</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start">
                  ...
                  <span className="text-gray-400">Art District, Creative City</span>
                </div>
              </div>
            </div>
            <div className="md:pl-8 md:border-l md:border-gray-800">
              ...
              <div className="mt-8">
                <h5 className="text-sm font-medium text-gray-500 mb-3">Business Hours</h5>
          ...
          <div className="border-t border-gray-800 mt-10 pt-6 text-center">
            <p className="text-gray-500 text-sm">© {new Date().getFullYear()} Mustafa Canvas. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
